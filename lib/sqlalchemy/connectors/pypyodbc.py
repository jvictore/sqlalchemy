...
class pypyodbcConnector(Connector):
    ...
    # this is no longer False for pypyodbc in general
    ...
    pypyodbc_driver_name: Optional[str] = None
    ...
    def do_set_input_sizes(
        ...
        # for types such as pypyodbc.SQL_WLONGVARCHAR, which is the datatype
